...
| Status | Note |
|--------|------|
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes an issue where equipping and unequipping tools sometimes caused full `FastCluster` (avatar rendering) rebuilds and framerate spikes. |
...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes occasional cursor lock when the app starts in the background. |
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes order-dependent logic when comparing attributes under server authority. |
