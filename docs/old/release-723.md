...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Adds `Class.ProceduralModel:ForceGeneration()`, which forces generation based on the current parameters to be done immediately if possible. This is unlike normal generation, which happens as a batch once per frame. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixed several UX/UI issues with Scene Analysis:                                                                                                                                                                                                                                                                                                                                         <br><br>• Close button works on the first click                   <br>• Better rendering at small widget sizes                                                                                                                                                                                                                                                                                                                                                <br>• Right-click Select Instances works across all applicable views<br>• Column widths: sensible defaults, per-view persistence, spreadsheet-style drag                                                                                                                                                                                                                                                                                                        <br>• Restored the original memory palette; red/green highlight memory changes                                                                                                                                                                                                                                                                                                              <br>• Warning carousel shows only relevant warnings per view; font matches the rest of the UI                                                                                                                                                                                                                                                                                               <br>• Fixed No-Data flicker on edit/play transitions                                                                                                                                                                                                                                                                                                                                        <br>• Manual refresh button when Autoupdate is off |
