...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes bug in Developer Console where if ancestor parts were parented to nil, descendant instances were not tracked as unparented. |
