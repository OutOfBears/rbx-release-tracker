...
| Status | Note |
|--------|------|
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | In the New Luau Type Solver, autocomplete on refinements of `any` will no longer exclude results *from* the refinement. |
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes potential improper occlusion culling by meshes with a `MeshSize` value of `0`. |
...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes mouse jitter when dragging the 3D camera view. |
