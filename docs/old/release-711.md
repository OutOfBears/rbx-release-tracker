...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | `Class.Instance:GetFullName()` is slightly faster and can handle arbitrarily deep instance hierarchies. |
...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes an issue with clouds shadows looking noisy during sunrise and sunset. |
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes an issue where `LockedToPart` property on `Class.ParticleEmitter` didn't work correctly in all cases. |
