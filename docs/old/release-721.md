...
| Status | Note |
|--------|------|
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Adds the `Class.UIShadow` component, which adds drop shadows to parent UI instances. |
...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Live Script reload now works for Parallel Luau. |
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | In the New Luau Type Solver, fixed a bug that could cause Studio hangs when type checking *many* copies of the same script calling a common function. |
