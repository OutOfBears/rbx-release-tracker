...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes a case where Script Analysis would report spurious warnings for certain generic functions in strict mode. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fix a case where script analysis would spuriously warn on anonymous functions in strict mode. |
...
| Status | Note |
|--------|------|
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Set a limit to the growth factor of deferred operations queued within any given resumption point. |
