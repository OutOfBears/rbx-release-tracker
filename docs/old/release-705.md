...
| Status | Note |
|--------|------|
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | `print(meshPart.MeshContent)` will now include the `Datatype.Content` source type. |
...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes a case where script analysis was not properly suppressing type errors between values of type "any." |
