...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Adds a new `Instance` type called `TextGenerator` that provides a method for getting LLM-generated text. |
