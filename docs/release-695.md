...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Adds frame rate cap options of 160, 165, 180, and 200 to the **Maximum Frame Rate** picker in the experience settings menu. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes collision detection issues with `Class.PhysicsService:CollisionGroupSetCollidable()` for nearby objects. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes `Class.BasePart.CanCollide` changes not being respected when a part is inside another's bounding box. |
