...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixed issue where Skybox with atmosphere at times loads with lower resolution. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes issue where editable image won't render on a decal with PBR maps. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fix Platform replication logic when platform is unanchored. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixed a bug for Chromebooks and Android devices with mice that sometimes prevented mouse buttons from working in first-person mode. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | SLIM support for Emissive Maps in Surface Appearance. |
