...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | In Studio's "New Luau type solver" beta, reading from an unknown variable will now produce an unknown symbol error in non-strict mode. |
