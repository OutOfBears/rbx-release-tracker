...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Removes the option to disable the Debugger in Roblox Studio. |
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Reassigns Capabilities for `MaterialVariant`, `Humanoid`, `RayValue`, and `AnalyticsService`. Also assigns Capabilities to more classes. |
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | More classes are now accessible to sandboxed instances. |
