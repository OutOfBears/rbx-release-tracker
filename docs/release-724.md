...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Logs more descriptive errors when attempting to build EditableMeshes through `Class.AssetService:CreateDataModelContentAsync` |
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | When deleting or renaming attributes in the Generator module of a ProceduralModel, Studio will automatically remove the old attributes from the ProceduralModel to avoid stale attributes accumulating as you edit. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | `VelocityPerpendicular` particle emitters now behave correctly with rotations. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes thumbstick directional keycodes in the Input Action System to apply Response Curve and Deadzone calculations properly. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes an issue where `Class.AudioPlayer.AutoPlay` doesn't work correct in a Team Create session. |
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes an issue where `Class.AudioListener` would flip its front/back channels in surround-sound formats. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Output Window now stacks prints that include links to Instances (e.g. "▶ Baseplate (x2)"). |
