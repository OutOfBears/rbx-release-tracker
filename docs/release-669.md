...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Improves performance for mouse raycast check. |
...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | In the New Luau Type Solver, fixed a class of issue where comparisons would cause non-<code>nil</code> values to suddenly become <code>nil</code> unexpectedly. |
