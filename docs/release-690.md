...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Improves error message for incompatible generic types in scripts typechecked with the new solver. |
