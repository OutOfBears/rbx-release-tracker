...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Improves performance by lowering the cost of `updateInstancedCluster2` when using SLIM. |
...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Luau's New Type Solver: Indexing into a table with an indexer who's keys are string singletons will now infer the indexer result type. |
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Luau autocomplete will now show string singleton keys when indexing into tables with a name expression, as in `A.B` |
...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes flakiness in `AudioSpeechToText` instantiation. |
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Emissive maps beta: Fixes a crash when importing a 3D model with missing files or broken content. |
