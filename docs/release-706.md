...
| ![Live](https://img.shields.io/badge/Live-009E57?style=flat)  | Fixes a bug that prevented autocomplete from displaying suggestions for require‑by‑string aliases like `@game` and `@self`. |
