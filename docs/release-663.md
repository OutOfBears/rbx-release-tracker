...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes a bug where the camera would reset angles when switching modes. |
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes <code>Class.Actor.SendMessage</code> in plugin scripts using the <code>RunContext</code> plugin. |
