...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Moves the Insert Object button back next to the Instance name under the Next Gen Explorer beta. |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Fixes a <code>require-by-string</code> issue where <code>require</code> calls inside closures resolve relative to an incorrect Instance. |
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Removes invalid unicode handling for characters in error logs on Windows. |
