...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Adds a <TBD> API for creating layered Decals |
...
| ![Pending](https://img.shields.io/badge/Pending-DEA517?style=flat)  | Reinstates "OOF" as the default death sound. |
